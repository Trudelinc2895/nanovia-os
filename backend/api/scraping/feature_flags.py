...
def browser_rendering_enabled() -> bool:
    return settings.SCRAPING_FEATURE_BROWSER_ENABLED and settings.SCRAPING_ENABLED
...
def async_queue_enabled() -> bool:
    return settings.SCRAPING_FEATURE_ASYNC_QUEUE_ENABLED and settings.SCRAPING_ENABLED
